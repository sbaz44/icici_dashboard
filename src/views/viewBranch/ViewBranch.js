        ...
        <React.Fragment>
          ...
          >
            <Button
              ...
              onClick={() => handleClickOpen(localData.open_image)}
            >
            ...
            <Button
              ...
              onClick={() => handleClickOpen(localData.close_image)}
            >
            ...
            <GridItem xs={12} sm={6} md={3}>
              <Card>
                <CardHeader color="rose" stats icon>
                  ...
                  <h3 className={classes.cardTitle}>{data.Tresspassing}</h3>
                </CardHeader>
                <CardFooter stats>
                  <a
                    href={
              ...
              <Card>
                <div style={{ width: "100%", height: "16vw" }}>
                  <ReactSpeedometer
                    ...
                    needleHeightRatio={0.7}
                    value={
                      Object.keys(data).length > 0 ? data.ATM_performance[0] : 0
                    }
                    customSegmentStops={[0, 5, 10, 20]}
                    maxValue={20}
                    segmentColors={["#0B8500", "#fb8c00", "#FF4433"]}
